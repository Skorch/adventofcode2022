...
def main(filename):
    ...
    for ix, group1_min, group1_max, group2_min, group2_max in read_file(filename):
        ...
        if group2_min >= group1_min and group2_max <= group1_max:
            print("group 2 contained in 1")
            total += 1
        elif group1_min >= group2_min and group1_max <= group2_max:
            print("group 1 contained in 2")
            total += 1
    print(total)
